...
#define DEBUGVIEW_FABRIC_SURFACEDATA_METALLIC (1008)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SPECULAR (1009)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SUBSURFACE_RADIUS (1010)
#define DEBUGVIEW_FABRIC_SURFACEDATA_THICKNESS (1011)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SUBSURFACE_PROFILE (1012)
#define DEBUGVIEW_FABRIC_SURFACEDATA_SPECULAR_COLOR (1013)
