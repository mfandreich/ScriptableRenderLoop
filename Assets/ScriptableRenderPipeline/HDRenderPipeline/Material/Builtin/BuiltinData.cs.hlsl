...
#define DEBUGVIEW_BUILTIN_BUILTINDATA_SHADOW_MASK (102)
#define DEBUGVIEW_BUILTIN_BUILTINDATA_EMISSIVE_COLOR (103)
#define DEBUGVIEW_BUILTIN_BUILTINDATA_EMISSIVE_INTENSITY (104)
#define DEBUGVIEW_BUILTIN_BUILTINDATA_VELOCITY (105)
