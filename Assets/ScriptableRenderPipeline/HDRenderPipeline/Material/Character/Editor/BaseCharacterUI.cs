...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    public abstract class BaseCharacterGUI : ShaderGUI
    {
        ...
        protected const string kHairTransparentDepthWriteEnable = "_TransparentDepthWritePrepassEnable";

        protected MaterialProperty hairCutoffPrepass = null;
        protected const string kHairCutoffPrepass = "_AlphaCutoffPrepass";

        protected MaterialProperty hairCutoffOpacityThreshold = null;
        protected const string kHairCutoffOpacityThreshold = "_AlphaCutoffOpacityThreshold";
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            hairCutoffOpacityThreshold = FindProperty(kHairCutoffOpacityThreshold, props);
